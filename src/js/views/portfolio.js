				...
				<div className="jumbotron mt-5 mb-5">
					<div className="row">
						<div className="col-4">
							...
							<p className="lead">
								Is your company struggling to connect with the needs of its customers? <br /> Does your
								brand or company message convey something different than that of your products or
								services? <br />
